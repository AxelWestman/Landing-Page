...
const primera_foto = document.querySelector(".first-article-image")
const segundo_articulo = document.getElementById("first-article-div12");
const segunda_foto = document.querySelector(".second-article-image");
...
const cargarImagen = (entradas, observador) => {
 ...
 observador.observe(primera_foto);
 observador.observe(segundo_articulo);
 observador.observe(segunda_foto);
